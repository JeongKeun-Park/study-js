...
// 게시글 모듈화화
// const postService = (() => {
// async를 사용하여 동기를 비동기로 변경
//     const getPosts = async (userId, callback) => {
// 비동기코드 앞에 await를 붙여주어서 순차적으로 코드를 읽도록 한다.
//         const response = await fetch("https://jsonplaceholder.typicode.com/posts");
// posts에 response로 받은 정보를 json으로 변경후 넣어준다
//         const posts = await response.json();

//         if (callback) {
// 받아올 값이 있기 때문에 return
...
// filter로 userID를 입력받은 아이디와 동일하게 맞춰준다.
